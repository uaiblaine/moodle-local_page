...
$string['accesslevel_negationonly'] = 'A capacidade obrigatória não pode ser formada apenas por entradas negadas. Uma regra como <code>!moodle/site:config</code> concede a página a todo visitante que <em>não</em> possui a capacidade, inclusive visitantes anônimos, e portanto não restringe nada. Acrescente uma capacidade positiva junto da negação.';
